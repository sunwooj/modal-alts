...
var rainList = shuffle([ ["rain0", "rain0"], ["rain10", "rain20"], ["rain30", "rain40"], ["rain50", "rain60"], ["rain70", "rain80"], ["rain90", "rain100"], ["filler-cold1", "filler-cold1"], ["filler-cold2", "filler-cold2"] 
...
var pictureRandom = Math.floor(Math.random() * 2);
...
function stepExperiment () {
    if (trialnum == 10) { // end the experiment. 
        ...
        if (trialnum < 3) {
            ...
            pictureVector = shuffle(rainList[trialnum-3]);
            // contextPic = pictureVector[pictureRandom+2];
            contextPic = pictureVector[pictureRandom];
